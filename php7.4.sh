...
sudo mkdir /etc/systemd/system/php7.4-fpm.service.d
sudo chown -R $SYS_USER:$SYS_USER /etc/systemd/system/php7.4-fpm.service.d
...
sudo bash -c 'cat > /etc/php/7.4/fpm/conf.d/my.ini' << 'EOF'
post_max_size = 128M
